...
wp_enqueue_script(sigsaClass::get_prefix().'_Locais');
wp_enqueue_media ();
...
if( isset($_REQUEST['ID']) ){
    ...
    <div class="plugin-content" style="opacity: 0;">
        ...
        <div class="page-header">
            <h3>Cadastro de local 
                <small>
                    <?=(isset($local->NMLocal))?$local->NMLocal:'';?>
                </small>
        ...
        <div class="page-content cadastro">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#cadastro" aria-controls="cadastro" role="tab" data-toggle="tab">Dados do local</a></li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="cadastro">
                    <div class="conteudo_aba">
                        ...
                        <?php
                            include SIGSA_PATH.'view/forms/cadastro-local.php';
                        ?>
                    </div>
                </div>
            </div>
    ...
    <div class="plugin-content" style="opacity: 0;">
        <input type="hidden" id="SIGSA_URL" value="<?=SIGSA_URL;?>"/>
        <div class="page-header">
            <h3>Locais <small>Lista</small></h3>
        </div>
        ...
        */
        $component_list_header = array(
            ...
            'quantidade_registros'  => Local::getQuantidadeRegistros()
        );
        ob_start();
        ?>
            ...
            <div class="form-group form-group-sm">
                <button type="button" class="btn btn-primary btn-sm bt_adicionaLocal">Adicionar</button>
            </div>
        <?php
        ...
        <?php 
            ...
            $registros = Local::getListaRegistros($filtro);
            //Local::printa($registros);
            include SIGSA_PATH.'view/tables/list-locais.php';
        ?>
